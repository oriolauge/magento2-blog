<?php
/**
 * attribute EAV resource model
 */
namespace OAG\Blog\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = PostSetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\OAG\Blog\Model\ResourceModel\Attribute::class);
    }
