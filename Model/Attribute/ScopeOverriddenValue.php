<?php
/**
 * Copied from Magento\Catalog\Model\Attribute\ScopeOverriddenValue
 * to avoid catalog dependency
 */

namespace OAG\Blog\Model\Attribute;
...
class ScopeOverriddenValue
{
     ...
     * @param \OAG\Blog\Api\Data\PostInterface $entity
